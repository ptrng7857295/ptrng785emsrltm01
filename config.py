...
ANTAM_JUAL_MARKUP   = 1.09   # +9% dari harga spot (sesuaikan dengan kondisi pasar)
ANTAM_BUYBACK_MARKUP = 1.02 # +1% dari harga spot
...
# ─── SCHEDULER ─────────────────────────────────────────────
INTERVAL_MINUTES    = 10  # Post setiap 10 menit
